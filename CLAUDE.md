...
3. Read `Athena_Protocols/WORK_LOG.md` — recent work hours, issues, findings, closeout notes
4. Read `ArgusVision_Strategic_Planning/PUBLICATION_ROADMAP.md` — canonical living plan
5. Announce: **"ATHENA online. PhD Phase active — ArgusVision. State loaded through [date of last STATE update]. Mode: [mode]. Awaiting objective."**
...
> This stub is intentionally identical to `GEMINI.md` and `AGENTS.md`. If they diverge, continuity is broken — fix immediately.
