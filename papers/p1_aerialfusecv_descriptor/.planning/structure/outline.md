...
| 5 | Data Description | ~700 w + 2 figs + 2 tables | Deposit tree file-by-file; splits table (1,401/456); per-class instance counts + match rates table; example-pair figure; class-distribution figure |
