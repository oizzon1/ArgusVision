...
| Next actions | User-gated: legacy `src/` deletion sweep + `AV_dev` branch removal. P0 Zenodo (Aug) — unblocks P1 Data Description + methods. Verify DiB APC. P2 prep: MMDetection-on-Windows (STATE OPEN 5), driver class_map passthrough for any VBB eval. |
