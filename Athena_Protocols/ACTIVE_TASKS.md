...
| F6b | Codex-Operator | OPERATOR | `task/f6b-tiling` | active | `experiments/tiling/**` (new files only) | 2026-08-04 | Measuring how much of the detection gap is input scale. Gates F7 protocol choice |
