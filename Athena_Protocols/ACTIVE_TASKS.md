...
| F6b | Codex-Operator | OPERATOR | `task/f6b-tiling` | ready-for-review | `experiments/tiling/**` (new files only) | 2026-08-04 | Full-image vs tiled YOLOv11x-OBB measured on 456-image val split; tiling should become P2 detector protocol with full-image as ablation |
