"""Diagnostic 2x2 collage visualization (ported unchanged from the thesis-era
visualization_v2; V1 absorbed — its example-saving role is superseded by the
evaluation stack + this module)."""
